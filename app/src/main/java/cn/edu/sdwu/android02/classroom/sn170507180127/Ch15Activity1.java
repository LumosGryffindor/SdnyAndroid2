...
public class Ch15Activity1 extends AppCompatActivity {
    ...
    public void query(View view){
        String[] setColumns={"id","stuname","stuadd","stutel"};
        Uri uri=Uri.parse(CONTENT_URI_STRING);
        Cursor cursor=contentResolver.query(uri,setColumns,null,null,null);
    ...
    public void delete(View view){
        Uri uri=Uri.parse(CONTENT_URI_STRING+"/2");//删除id为2的
