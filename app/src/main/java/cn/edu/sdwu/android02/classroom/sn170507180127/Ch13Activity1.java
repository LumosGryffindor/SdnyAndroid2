...
public class Ch13Activity1 extends AppCompatActivity {
    ...
    public void read(View view){
        try{
            ...
            int size=fileInputStream.available();//获取文件大小
            //声明字节的数组
    ...
    private void writeExternal(String content){
        ...
        //创建File对象
        File file=new File(Environment.getExternalStorageDirectory(),"abced.txt");//构造方法中，提供文件所在的目录名和文件名
    try{
        //使用createNewFile创建文件
        file.createNewFile();
        //判断文件是否存在，是否可写
